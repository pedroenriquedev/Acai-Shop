...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{}],"model/Item.js":[function(require,module,exports) {
"use strict";
...
var Item = function Item(size, AddOns, instructions, price, quantity) {
...
},{"@babel/runtime/helpers/classCallCheck":"../../node_modules/@babel/runtime/helpers/classCallCheck.js"}],"model/List.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":"../../node_modules/@babel/runtime/helpers/classCallCheck.js"}],"view/base.js":[function(require,module,exports) {
"use strict";
...
var fruitAddOn = document.getElementById('fruitAddOn');
...
},{}],"view/itemView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clearAllInputs = exports.getAddOn = exports.getSize = void 0;

var _base = require("./base");

var getSize = function getSize(sizeOptions) {
  return sizeOptions.find(function (el) {
    return el.checked;
  });
};
...
var getAddOn = function getAddOn(category) {
  // category => array from base.js
  var selectedAddOns = category.map(function (el) {
...
var clearAllInputs = function clearAllInputs(inputs) {
  inputs.forEach(function (el) {
    el.checked = false;
  });
};

exports.clearAllInputs = clearAllInputs;
},{"./base":"view/base.js"}],"view/alerts.js":[function(require,module,exports) {
"use strict";
...
},{}],"view/listView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateListNum = void 0;

var _base = require("./base");

var updateListNum = function updateListNum(arr) {
  _base.elements.listViewNumber.innerHTML = arr.length;
};

exports.updateListNum = updateListNum;

var renderItem = function renderItem(item) {};
},{"./base":"view/base.js"}],"view/spinningCircle.js":[function(require,module,exports) {
"use strict";
...
var loadSpinner = function loadSpinner(div) {
...
exports.Base64 = exports.extendBuiltins = exports.extendUint8Array = exports.extendString = exports.toUint8Array = exports.fromUint8Array = exports.isValid = exports.btou = exports.encodeURL = exports.encodeURI = exports.utob = exports.encode = exports.toBase64 = exports.decode = exports.fromBase64 = exports.btoaPolyfill = exports.btoa = exports.atobPolyfill = exports.atob = exports.VERSION = exports.version = void 0;
...
},{"buffer":"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var itemView = _interopRequireWildcard(require("./view/itemView"));

var _alerts = require("./view/alerts");

var listView = _interopRequireWildcard(require("./view/listView"));

var _spinningCircle = require("./view/spinningCircle");
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            (0, _spinningCircle.loadSpinner)(_base.elements.loginBtn);
            _context2.next = 4;
            return axios({
              method: 'POST',
          ...
          case 8:
            ...
            _base.elements.loginBtn.innerHTML = 'Login';
...
var signUp = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(name, email, password, passwordConfirm) {
    var res;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            (0, _spinningCircle.loadSpinner)(_base.elements.signUpBtn);
            _context3.next = 4;
            return axios({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your account has been created!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 8:
            ...
            _base.elements.signUpBtn.innerHTML = 'Sign up';
...
window.onload = function (e) {
  if (localStorage.getItem('items') !== null) {
    ...
    state.list.items.forEach(function (e, i) {
      e.checkout_id = i;
    });
  } else {
    state.list.items = [];
...
var itemControl = function itemControl(isPreLoad) {
  var size;

  if (itemView.getSize(_base.elements.sizeInput)) {
    size = parseInt(itemView.getSize(_base.elements.sizeInput).dataset.size);
  } else {
    size = -1;
  }
  ...
  var addOns = {
    fruits: itemView.getAddOn(_base.elements.fruitsAddOn),
    toppings: itemView.getAddOn(_base.elements.toppingAddOn),
    drizzle: itemView.getAddOn(_base.elements.drizzleAddOn),
    powder: itemView.getAddOn(_base.elements.powderAddOn)
  };
  var instr = _base.elements.itemInstructions.value;
  var quantity = 1;

  if (size !== -1) {
    var acai = new _Item.default(size, addOns, instr, price, quantity);
    itemView.clearAllInputs(_base.elements.allInput);
    state.acai = acai;
    if (!isPreLoad) (0, _alerts.showAlert)('success', 'Successfully added!');
  } else {
    if (!isPreLoad) (0, _alerts.showAlert)('error', 'Please select a size');
    state.acai = null;
  }
};

var listControl = function listControl() {
  if (!state.list) state.list = new _List.default();

  if (state.acai !== null) {
    // add item to list
    state.list.items.push(state.acai); // update num (just number)
  }
}; //reviewOrder page functions


var updateTotalUI = function updateTotalUI() {
  var total = 0;
  var totals = Array.from(document.querySelectorAll('.shoppingCart__item-total'));
  totals.forEach(function (el, index) {
    total = total + parseInt(el.innerHTML.split('$')[1]);
  });
  _base.elements.total.innerHTML = "Total: $ ".concat(total);
};

var updateNumberOfItems = function updateNumberOfItems(num) {//elements.listViewNumber.innerHTML = `${num}`;
}; // selectAcai page listeners


if (_base.elements.addToCartBtn) {
  _base.elements.addToCartBtn.addEventListener('click', function () {
    itemControl(false);
    listControl();
    updateNumberOfItems(state.list.items.length); // back to top of the page TODO
  });
}

var loadReviewOrderPage = function loadReviewOrderPage(e) {
  e.preventDefault(); //take json obj and convert it to string
  ...
  itemControl(true);
  listControl();
  var str = JSON.stringify(state.list.items); //take the string and encode it in Base64

  localStorage.setItem('items', str);
  console.log(localStorage);
  str = Base64.encode(str); //append it to the URL andmake the get call

  var param = "items=".concat(str);
  var url = "/reviewOrder?".concat(param);
  window.location.href = url;
};

if (_base.elements.reviewOrderBtn) {
  _base.elements.reviewOrderBtn.addEventListener('click', loadReviewOrderPage);
} // reviewOrder page listeners


if (_base.elements.addQuantityBtns) {
  _base.elements.addQuantityBtns.forEach(function (el) {
    el.addEventListener('click', function () {
      var quantityBox = el.previousElementSibling;
      var quantity = parseInt(quantityBox.innerHTML);
      var itemBox = el.parentNode.parentNode;
      var totalBox = itemBox.querySelector('.shoppingCart__item-total');
      var id = parseInt(el.parentNode.parentNode.classList[1].split('-')[1]);
      quantity = quantity + 1; // update state list (quantity)
      ...
      var price = parseInt(itemBox.querySelector('.shoppingCart__item-price').innerHTML.split('$')[1]);
      totalBox.innerHTML = "$ ".concat(price * quantity);
      updateTotalUI();
    });
  });
}

if (_base.elements.removeQuantityBtns) {
  _base.elements.removeQuantityBtns.forEach(function (el) {
    el.addEventListener('click', function () {
      var quantityBox = el.nextElementSibling;
      var quantity = parseInt(quantityBox.innerHTML);
      var itemBox = el.parentNode.parentNode;
      var totalBox = itemBox.querySelector('.shoppingCart__item-total');
      var id = parseInt(el.parentNode.parentNode.classList[1].split('-')[1]); // update state list (quantity)
...
if (_base.elements.removeBtn) {
  _base.elements.removeBtn.forEach(function (el, i) {
    el.addEventListener('click', function () {
      var id = parseInt(el.parentNode.classList[1].split('-')[1]); // remove from state
      ...
      var str = JSON.stringify(state.list.items);
      localStorage.setItem('items', str); // because of the rendering logic, we need to update the url

      str = Base64.encode(str);
      var url = "/reviewOrder?items=".concat(str);
      window.history.pushState({}, '', url); // remove from ui

      _base.elements.itemsContainer.removeChild(el.parentNode);
...
var createStripeSession = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(items) {
    var res, url;
  ...
  return function createStripeSession(_x7) {
    return _ref4.apply(this, arguments);
  };
}();

if (_base.elements.checkoutBtn) {
  _base.elements.checkoutBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regenerator.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault(); //console.log(state.list);
              ...
              (0, _alerts.showAlert)('error', 'Your cart is empty. Try adding some acais first!');
              return _context5.abrupt("return");

            case 4:
              ;

              if (_base.elements.userBtn) {
                _context5.next = 10;
                break;
              }

              blurredElements = [_base.elements.navBar, _base.elements.shoppingCart, _base.elements.footer];
              blurredElements.forEach(function (e) {
                e.classList.add('blur');
              });

              _base.elements.createAnAcc.classList.add('display');
...
if (_base.elements.checkoutAsGuestBtn) {
  _base.elements.checkoutAsGuestBtn.addEventListener('click', /*#__PURE__*/function () {
...
if (_base.elements.editBtns) {
  _base.elements.editBtns.forEach(function (el, i) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var id = parseInt(el.parentNode.classList[1].split('-')[1]);
      var item = state.list.items.find(function (item) {
      ...
      var itemsStr = JSON.stringify(state.list.items);
      localStorage.setItem('items', itemsStr);
      var str = JSON.stringify(item);
      str = Base64.encode(str);
      var url = "/?item=".concat(str);
      window.location.href = url;
    });
  });
...
if (_base.elements.loginForm) {
  _base.elements.loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = _base.elements.loginEmail.value;
    var password = _base.elements.loginPassword.value;
...
if (_base.elements.signUpForm) {
  _base.elements.signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = _base.elements.signUpName.value;
    var email = _base.elements.signUpEmail.value;
    var password = _base.elements.signUpPassword.value;
    var passwordConfirm = _base.elements.signUpPasswordConfirm.value;
    signUp(name, email, password, passwordConfirm);
  });
}

if (_base.elements.logoutBtn) {
  _base.elements.logoutBtn.addEventListener('click', function (e) {
    e.preventDefault();
    logout();
  });
...
var resetPasswordAPI = /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee7(newPassword, newPasswordConfirm, token) {
    var res;
    return _regenerator.default.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            (0, _spinningCircle.loadSpinner)(_base.elements.resetPasswordBtn);
            _context7.next = 4;
            return axios({
              method: 'PATCH',
          ...
          case 8:
            ...
            _base.elements.resetPasswordBtn.innerHTML = 'Reset Password';
  ...
  return function resetPasswordAPI(_x10, _x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();

if (_base.elements.resetPasswordForm) {
  _base.elements.resetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var newPassword = _base.elements.resetPassword.value;
    var newPasswordConfirm = _base.elements.resetPasswordConfirm.value;
...
if (_base.elements.forgotPasswordBtn) {
  _base.elements.forgotPasswordBtn.addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = "/forgotPassword";
  });
}

var sendResetPassEmail = /*#__PURE__*/function () {
    ...
    return _regenerator.default.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            (0, _spinningCircle.loadSpinner)(_base.elements.forgotPasswordFormBtn);
            _context8.next = 4;
            return axios({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.message === 'success') {
              (0, _alerts.showAlert)('success', 'Email sent successfully! Check your inbox!');
              _base.elements.forgotPasswordFormBtn.innerHTML = 'Reset Password'; //window.setTimeout(() => { location.assign('/') }, 1500)
            }
          ...
          case 9:
            ...
            _base.elements.forgotPasswordFormBtn.innerHTML = 'Reset Password';
  ...
  return function sendResetPassEmail(_x13) {
    return _ref8.apply(this, arguments);
  };
}();

if (_base.elements.forgotPasswordForm) {
  _base.elements.forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = _base.elements.forgotPasswordEmail.value;
    sendResetPassEmail(email);
  });
}

if (_base.elements.inputOptions) {
  _base.elements.inputOptions.forEach(function (input) {
    input.addEventListener('change', function (e) {
      var optionsContainer = e.target.parentElement;
      var options = Array.from(optionsContainer.getElementsByTagName('input'));
      var checkedOptions = options.filter(function (option) {
        return option.checked === true;
      });

      if (checkedOptions.length > 4) {
        (0, _alerts.showAlert)('error', 'Please choose up to 4 from each add-ons!');
...
},{"@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","./model/Item":"model/Item.js","./model/List":"model/List.js","./view/base":"view/base.js","./view/itemView":"view/itemView.js","./view/alerts":"view/alerts.js","./view/listView":"view/listView.js","./view/spinningCircle":"view/spinningCircle.js","js-base64":"../../node_modules/js-base64/base64.mjs","axios":"../../node_modules/axios/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
